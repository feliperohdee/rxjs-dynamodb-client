...
module.exports = class Request {
    ...
    addPlaceholderName(name) {
        ...
        if (_.isArray(name)) {
            _.forEach(name, value => _.set(this.expressionAttributeNames, `#${value}`, value));
        } else {
            _.forEach(name, (value, key) => _.set(this.expressionAttributeNames, `#${key}`, value));
        }
    ...
    addPlaceholderValue(value) {
        ...
        if (_.isArray(value)) {
            _.forEach(value, value => _.set(this.expressionAttributeValues, `:${value}`, this.util.anormalizeValue(value)));
        } else {
            _.forEach(value, (value, key) => _.set(this.expressionAttributeValues, `:${key}`, this.util.anormalizeValue(value)));
        }
