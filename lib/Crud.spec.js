        ...
        request.query({
            ...
            .pipe(
                ...
                rxop.mergeMap(response => {
                    return request.batchWrite(response);
                })
            )
            .subscribe(testing.rx(null, null, done));
    });
