...
describe('lib/Request', () => {
    ...
    before(done => {
        client = testing.dynamodb.client;
        request = testing.dynamodb.table(tableName, tableSchema);

        request.describe()
            .pipe(
                rxop.catchError(() => {
                    return request.routeCall('createTable', {
                        TableName: 'tblSpec',
    ...
    describe('table', () => {
        ...
        it('should return Request dynamodb', () => {
            expect(testing.dynamodb.table(tableName, tableSchema)).to.be.instanceOf(Request);
        });
    });
    ...
    describe('query', () => {
        ...
        it('should responds with resumed data', done => {
            ...
            query.pipe(
                    rxop.mergeMap(() => {
                        return resumedQuery(request.queryStats.after);
                    })
                )
                .subscribe(testing.rx(response => {
                    expect(response).to.deep.equal([{
        ...
        it('should feed queryStats', done => {
            request.limit(2)
                .resume({
                    namespace,
                    id: 'id-2'
    ...
    describe('getIndexedAttributes', () => {
        ...
        beforeEach(() => {
            getIndexedAttributes = () => {
                return request.getIndexedAttributes({
                    namespace: 'namespace',
                    id: 'id',
        ...
        describe('toDelete', () => {
            beforeEach(done => {
                request.batchWrite(null, [{
                    ...
                    .subscribe(testing.rx(null, null, () => {
